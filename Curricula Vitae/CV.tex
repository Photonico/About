...
\quad Computational condensed matter physics; topological matter; physics of complex systems; and AI for physics.
...
\begin{tabularx}{\textwidth}{@{}>{\bfseries}p{10.35em}X@{}}
...
\quad Tutor for a graduate-level course in quantum mechanics and mathematical methods during the PhD candidature. Developed detailed teaching notes covering linear algebra, operator formalism, and mathematical methods used in quantum mechanics.
