...
\address{GitHub.com/ConAntares}
\address{LukeNiu@outlook.com} % Your phone number and email
%\address{(000)~$\cdot$~111~$\cdot$~1111 \\ LukeNiu@outlook.com} % Your phone number and email
